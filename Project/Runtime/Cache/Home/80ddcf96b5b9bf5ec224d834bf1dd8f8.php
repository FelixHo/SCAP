...
<div class="postlist">
    <legend><span class="glyphicon glyphicon-bookmark" style="top: 4px;color: #d9534f"></span> <strong><?php echo ($subject); ?></strong></legend>
    <div class="row wrap">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-lg-8 col-xs-12" style="padding-left: 2px;">
                <span style="font-size: 400 ; line-height: 30px;color: #248dc1">
                        <i class="glyphicon glyphicon-user" style="top: 4px;"></i> <span><span class="badge" style="background-color: #d9534f;color: #ffffff"><?php echo ($members_num); ?></span></span>
                        <i class="glyphicon glyphicon-comment" style="top: 4px;margin-left: 5px;"></i> <span class="badge" style="background-color: #d9534f;color: #ffffff"><?php echo ($replies); ?></span>
                        <i class="glyphicon glyphicon-eye-open" style="top: 4px;margin-left: 5px;"></i> <span class="badge" style="background-color: #d9534f;color: #ffffff"><?php echo ($views); ?></span>
                </span>
            </div>
            <div class="col-md-4 col-sm-4 col-lg-4 hidden-xs text-right" style="padding-top: 5px;">
                <button type="button" class="btn btn-info btn-xs" >
                    <span class="glyphicon glyphicon-info-sign" style="top: 2px;"></span> <span onclick="loadPageActivityInfo(<?php echo ($aid); ?>);">活动介绍</span>
                </button>
            </div>
        ...
        <div class="timeline-centered">
       		<?php switch($haspost): case "true": ?><article class="timeline-entry">
            ...
            <?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$post): $mod = ($i % 2 );++$i;?><article class="timeline-entry">
	                <div class="timeline-entry-inner">
	                    <div class="timeline-icon bg-success">
	                        <i class="entypo-feather" onclick="loadPageProfile(<?php echo ($post["uid"]); ?>);" style="cursor: pointer;"><img class="img-circle" style="width:100%;height:100%" src="http://scap.mama.cn/upload/avatar/thumbmini_<?php echo ($post["avatar"]); ?>"/></i>
	                    </div>
	                    <div class="timeline-label">
	                        <h2><a href="#" onclick="loadPageProfile(<?php echo ($post["uid"]); ?>);"><?php echo ($post["username"]); ?></a> <span><?php echo ($post["friendly_date"]); ?></span></h2>
	                        <p><?php echo ($post["content"]); ?></p>
	                        <?php switch($post["hasimg"]): case "1": ?><img src="http://scap.mama.cn/upload/post/image/thumbsmall_<?php echo ($post["img"]); ?>" data-imgname="<?php echo ($post["img"]); ?>" class="img-responsive img-rounded full-width postimg" data-toggle="modal" data-target="#lightbox"><?php break; endswitch;?>
	                    </div>
	                </div>
...
<form id="postform" action="http://scap.mama.cn/Home/Post/addPost" enctype="multipart/form-data" method="post" >
...
$(function(){
    ...
    $('.postimg').on('click', function(event) {
        ...
        var $img = $(this), 
            src = "http://scap.mama.cn/upload/post/image/thumbmedium_"+imgname,
            alt = $img.attr('alt'),
            css = {
    ...
    $(".lightbox-img").on('click',function(e){
    	...
    	var src = "http://scap.mama.cn/upload/post/image/"+name;
